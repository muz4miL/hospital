  ...
  const fetchTasks = () => {
    fetch("http://localhost:3000/api/task/read")
      ...
      .then((data) => {
        ...
        const notdeliveredTaskCount = tasks.filter(
          (task) =>
    ...
    <div className="flex min-h-screen bg-zinc-950">
      ...
      <div className="flex-1 overflow-auto">
        <div className="px-6 py-6 flex items-center justify-between border-b border-zinc-800">
          <div>
            ...
            <p className="text-zinc-500 text-sm mt-1">
              Delivery task overview and tracking
            </p>
          </div>
        ...
        <div className="px-6 py-5 grid grid-cols-3 gap-4 border-b border-zinc-800">
          ...
          <div className="bg-zinc-900 border border-amber-900/40 rounded-xl p-5 shadow-lg shadow-black/20">
            <p className="text-zinc-400 text-sm">Pending Delivery</p>
            <p className="text-3xl font-bold text-amber-400 mt-1">
              {notdeliveredTaskCount}
            </p>
          </div>
        </div>
        <DeliveryTaskTable />
