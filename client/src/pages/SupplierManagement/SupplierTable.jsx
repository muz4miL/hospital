        ...
        <div>
            <form  className='px-10 py-2 pb-7 flex justify-end' onSubmit={handleSearch}>
                <div className='relative'>
                    <input type='text' placeholder='Search Suppliers' className='bg-gray-800 border-2 border-gray-700 rounded-md placeholder-gray-500 text-white focus:outline-none w-56 p-2 pl-10' onChange={(e) => setSearchQuery(e.target.value)} value={searchQuery}/>
        ...
        <table className="w-full border-2 border-gray-700">
            <thead>
                <tr className="bg-gray-800 text-white text-left">
                    ...
                    <th className="border border-gray-700 px-4 py-2">Conatct Person</th>
            ...
            <tbody>
                {searchResults?.map((elem, index) => {
                    ...
                    <tr key={index} className="bg-gray-900 text-gray-300">
                        <td className="border-b border-gray-700 px-4 py-2">{elem.supplierID}</td>
