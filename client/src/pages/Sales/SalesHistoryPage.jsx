        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-gray-500 text-sm mt-1">
              Track revenue, view invoices, and analyze trends
            </p>
          </div>
          <button
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
            <div className="bg-gray-900 rounded-xl p-4 border border-gray-800">
              ...
              <p className="text-gray-600 text-xs mt-1">
                {todaySummary.totalTransactions || 0} sales today
              </p>
            </div>
            <div className="bg-gray-900 rounded-xl p-4 border border-gray-800">
              <p className="text-gray-500 text-xs uppercase tracking-wide">
              ...
              <p className="text-gray-600 text-xs mt-1">
                {todaySummary.totalRevenue > 0
                  ? (
                      (todaySummary.totalProfit / todaySummary.totalRevenue) *
                      100
                    ).toFixed(1)
                  : "0"}
                % margin
              ...
              <p className="text-2xl font-bold text-white mt-1">
                {formatCurrency(
                  todaySummary.totalTransactions > 0
                    ? todaySummary.totalRevenue / todaySummary.totalTransactions
                    : 0,
                )}
              </p>
            ...
            <div className="bg-gray-900 rounded-xl p-5 border border-gray-800">
              ...
              <div className="space-y-3">
                {(analytics.paymentBreakdown || []).map((p, i) => {
                  const total = analytics.paymentBreakdown.reduce(
                    (s, x) => s + x.total,
                    0,
                  );
                  ...
                  return (
                    <div key={i}>
                      ...
                      <div className="w-full bg-gray-800 rounded-full h-2">
                        <div
                          className={`${colors[p.method] || "bg-gray-500"} h-2 rounded-full transition-all`}
                          style={{ width: `${pct}%` }}
                        ></div>
                      </div>
                    </div>
                  ...
                  <tr>
                    <td colSpan="7" className="text-center py-12 text-gray-600">
                      ...
                      <p className="text-xs mt-1">
                        Sales made from POS will appear here
                      </p>
                    </td>
                  </tr>
                ) : (
                      ...
                      >
                        ...
                        <td className="px-4 py-3 text-right">
                          ...
                          {sale.discountAmount > 0 && (
                            <p className="text-gray-600 text-xs">
                              -{formatCurrency(sale.discountAmount)} disc
                            </p>
                          )}
                        </td>
                        <td className="px-4 py-3 text-center">
                          <span
                            className={`px-2 py-0.5 rounded-full text-xs font-medium ${paymentColors[sale.paymentMethod] || "text-gray-400 bg-gray-800"}`}
                          >
                            {sale.paymentMethod}
                          </span>
                        </td>
                        ...
                        <td className="px-4 py-3 text-center">
                          <div className="flex items-center justify-center gap-1">
                            <button
                              ...
                              className="p-1.5 text-gray-500 hover:text-emerald-400 hover:bg-gray-800 rounded transition"
                              title="View"
                            >
            ...
            <div className="p-5 border-b border-gray-800 flex items-center justify-between">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="p-2 text-gray-400 hover:text-emerald-400 hover:bg-gray-800 rounded transition"
                >
                  <FiPrinter />
                </button>
                <button
            ...
            <div className="p-5">
              <div className="space-y-2 text-sm mb-4">
                <div className="flex justify-between">
                  ...
                  <span className="text-gray-300">
                    {new Date(selectedSale.createdAt).toLocaleString("en-PK")}
                  </span>
                </div>
                <div className="flex justify-between">
              ...
              <div className="border-t border-dashed border-gray-700 pt-3 space-y-1">
                ...
                {selectedSale.discountAmount > 0 && (
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="text-red-400">
                      -PKR {selectedSale.discountAmount}
                    </span>
                  </div>
                )}
                <div className="flex justify-between text-base font-bold pt-1">
                  ...
                  <span className="text-emerald-400">
                    PKR {selectedSale.grandTotal}
                  </span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-gray-500">Paid</span>
                  <span className="text-gray-300">
                    PKR {selectedSale.amountPaid}
                  </span>
                </div>
